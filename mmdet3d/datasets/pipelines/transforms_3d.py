...
class ObjectSample(object):
    ...
    def __call__(self, input_dict):
        ...
        if gt_bboxes_3d is None and 'gt_boxes' in input_dict:
            gt_bboxes_3d = input_dict['gt_boxes']
        if gt_bboxes_3d is None:
            raise KeyError("Neither 'gt_bboxes_3d' nor 'gt_boxes' found in input_dict")
